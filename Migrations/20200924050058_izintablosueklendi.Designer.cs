...
namespace YillikIzin.Migrations
{
    ...
    [Migration("20200924050058_izintablosueklendi")]
    partial class izintablosueklendi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YillikIzin.Models.Izintur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("YillikIzin.Models.Izin", b =>
                {
                    ...
                    b.HasOne("YillikIzin.Models.Izintur", "Izintur")
                        .WithMany()
                        .HasForeignKey("TurId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
